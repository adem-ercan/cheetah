  ...
  List<Widget> _registerFormListWidget(BuildContext context,
    ...
    formWidgetList =  [
      CheetahTextFormField(
        ...
        onSaved: (value) => formModel.onSave(value!, formModel.fieldNumberIdList[0]),
      ...
      CheetahTextFormField(
        ...
        validator: (value) => formModel.formNameValidate(value),
        onSaved: (value) => formModel.onSave(value!, formModel.fieldNumberIdList[1]),
        onChange: (value) => formModel.onChange(value, formKey),
      ),
      const SizedBox(height: 10),
      CheetahTextFormField(
        ...
        validator: (value) => formModel.formNameValidate(value),
        onSaved: (value) => formModel.onSave(value!, formModel.fieldNumberIdList[2]),
        onChange: (value) => formModel.onChange(value, formKey),
      ),
      const SizedBox(height: 10),
      CheetahTextFormField(
        ...
        prefixIconC: const Icon(Icons.vpn_key_outlined),
        validator: (value) => formModel.formNameValidate(value),
        onSaved: (value) => formModel.onSave(value!, formModel.fieldNumberIdList[3]),
        onChange: (value) => formModel.onChange(value, formKey),
      ),
      const SizedBox(
        height: 5,
      ...
      GradientRaisedButton(
          buttonText: "Sign Up", func: () => formModel.formSave(formKey)),
      const SizedBox(
        height: 20,
      ),
      Row(
