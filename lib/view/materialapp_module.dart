  ...
  Widget build(BuildContext context) {
    return MultiProvider(
        ...
        providers: [
          ...
          ChangeNotifierProvider<ComponentState>(
              create: (context) => ComponentState()),
          ...
          ChangeNotifierProvider<ContextRepository>(
              create: (context) => ContextRepository()),
        ],
        child: FutureBuilder(
            future: Init.instance.initialize(),
            builder: (context, snapshot) {
              final themeData =
                  Provider.of<ThemeModeView>(context, listen: true);
